...
namespace HotCoreUtils.Uploader
{    
    /// <summary>
    /// 图片处理类
    /// </summary>
    public class ImageHelper
    {
        ...
        public static void SaveSmallImage(string fileName, string newFile, int maxHeight, int maxWidth)
        {
        ...
        /// <param name="maxHeight"></param>
        /// <param name="maxWidth"></param>
        public static void SaveSmallImage(Stream fileStream, string newFile, int maxHeight, int maxWidth)
        {
        ...
        /// <param name="quality">质量（范围0-100）</param>
        public static void CutForCustom(Stream stream, string fileSaveUrl, int maxWidth, int maxHeight, int quality)
        {
